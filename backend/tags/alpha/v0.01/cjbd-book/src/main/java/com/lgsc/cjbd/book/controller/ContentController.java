...
public class ContentController {
	...
	public Response select(@ApiParam(value = "内容编号", required = true) @PathVariable(name="id") Long contentId,@ApiParam(value = "访问标记 index==门户 admin==后台", required = true)@PathVariable(required=true,value="from") String from) {
